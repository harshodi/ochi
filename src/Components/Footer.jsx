...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen p-20 border-t-[1px] border-zinc-700">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[8vw] font-semibold leading-none -mb-6">EYE-</h1>
          <h1 className="text-[8vw] font-semibold leading-none -mb-6">
            OPENING
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw] font-semibold leading-none -mb-8">
          PRESENTATIONS
        </h1>
        <div className="dets flex mt-20">
          <div>
            <h1 className="mb-5 text-xl">S:</h1>
            ...
            <h1 className="mt-5 text-xl">L:</h1>
            {[
              "202-1965 W 4th Ave",
              "Vancover, Canada",
              "30 Chukarina st",
              ...
              <a
                className={`block text-xl font-light ${index === 2 && "mt-5"}`}
                href="#"
              >
                <u>{item}</u>
              </a>
