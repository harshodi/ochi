    ...
    <div className="w-full py-20">
      ...
      <div className="px-20">
        <div className="cards w-full flex gap-20 mt-10">
          ...
          >
            <h1 className="absolute flex left-full overflow-hidden text-[#c7de73] top-1/2 -translate-y-1/2 -translate-x-1/2 z-[9] text-8xl font-semibold">
          ...
          <motion.div
            ...
            className="cardcontainer relative w-1/2 h-[80vh]"
          >
            <h1 className="absolute flex overflow-hidden right-full text-[#c7de73] top-1/2 -translate-y-1/2 translate-x-1/2 z-[9] text-8xl font-semibold">
